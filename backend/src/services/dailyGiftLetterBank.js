...
const LETTER_BODIES = [
  ...
  "💌 Gửi bạn của hôm nay: đừng bỏ cuộc chỉ vì một vài câu khó. Câu khó không xuất hiện để làm bạn nản, mà để nhắc bạn rằng mình còn có chỗ để tiến bộ. Cứ bình tĩnh đọc lại đề, làm từng bước một, sai thì sửa, chưa hiểu thì học lại. Moly vẫn tin bạn đang đi đúng đường đó 🧡",
  ...
  "💌 Gửi bạn đang chuẩn bị học: hôm nay hãy nhẹ nhàng với bản thân, nhưng đừng dễ dãi với mục tiêu nhé. Mình có thể nghỉ một chút khi mệt, có thể làm chậm hơn khi rối, nhưng đừng bỏ hẳn điều mình từng rất muốn đạt được. Mỗi buổi học nhỏ là một lần bạn chọn tương lai của mình ✨",
