...
class MTEF:
    ...
    def readRecord(self):
        ...
        pass # print('(DEBUG)MTEF.readRecord.mMtefVer:', self.mMtefVer)
        pass # print('(DEBUG)MTEF.readRecord.mPlatform:', self.mPlatform)
        pass # print('(DEBUG)MTEF.readRecord.mProduct:', self.mProduct)
        pass # print('(DEBUG)MTEF.readRecord.mVersion:', self.mVersion)
        pass # print('(DEBUG)MTEF.readRecord.mVersionSub:', self.mVersionSub)
        pass # print('(DEBUG)MTEF.readRecord.mApplication:', self.mApplication)
        pass # print('(DEBUG)MTEF.readRecord.mInline:', self.mInline)
        ...
        while True:
            ...
            if record == RecordType.END:
                ...
                self.Valid = False
                pass # print('MTEF.readRecord:FUTURE RECORD:', record)
    ...
    def readDimensionArrays(self, size):
        ...
        def fx(x):
            ...
            if shareData['flag']:
                if x == 0x00:
                    ...
                    pass # print('MTEF.readDimensionArrays.error: invalid bytes')
            else:
                if x == 0x00:
                    shareData['flag'] = False
                    shareData['tmpStr'] += '0'
        ...
        while True:
            if shareData['count'] >= size:
                pass # print('(DEBUG)MTEF.readDimensionArrays:break with size=', size)
                break
    ...
    def Translate(self):
        ...
        if err is not None:
            pass # print('MTEF.Translate.err:', err)
    ...
    def makeLatex(self, ast):
        ...
        if ast.tag == RecordType.ROOT:
            ...
            if tmpl.selector == SelectorType.tmANGLE:
                ...
                for vCode in variationsCode:
                    ...
                    if vCode&tmpl.variation != 0:
                        ...
                        if arrowStyle == "single" and variationsMap[vCode] == "pointLeft":
                            ...
                            pass # print('MTEF.makeLatex: not implement double , large over small')
                        elif arrowStyle == "harpoon" and variationsMap[vCode] == "pointLeft":
                            pass # print('MTEF.makeLatex: not implement harpoon, large over small')
                        ...
                        if arrowStyle == "single" and variationsMap[vCode] == "pointRight":
                            ...
                            pass # print('MTEF.makeLatex: not implement double , small over large')
                        elif arrowStyle == "harpoon" and variationsMap[vCode] == "pointRight":
                            pass # print('MTEF.makeLatex: not implement harpoon, small over large')
                """
                    variation转码 END
                """
                ...
                self.Valid = False
                pass # print('MTEF.makeLatex:TMPL NOT IMPLEMENT', tmpl.selector, tmpl.variation)
            for _ast in ast.children:
                _latex, _ = self.makeLatex(_ast)
                buf += _latex
            return buf, None
            ...
            if embellType == EmbellType.emb1DOT:
                ...
                pass # print('METF.makeLatex:not implement embell:', embellType)
