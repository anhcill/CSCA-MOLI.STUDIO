...
const config = {
  ...
  adminExam: {
    ...
    model: normalizeBeeknoeeModel(process.env.ADMIN_EXAM_AI_MODEL || process.env.NINEROUTER_MODEL || process.env.BEEKNOEE_IMPORT_MODEL || 'google/gemini-3.1-flash-lite'),
    ocrModel: normalizeBeeknoeeModel(process.env.ADMIN_EXAM_AI_OCR_MODEL || process.env.ADMIN_EXAM_AI_MODEL || process.env.NINEROUTER_MODEL || process.env.BEEKNOEE_OCR_MODEL || 'google/gemini-3.1-flash-lite'),
    importModel: normalizeBeeknoeeModel(process.env.ADMIN_EXAM_AI_IMPORT_MODEL || process.env.ADMIN_EXAM_AI_MODEL || process.env.NINEROUTER_MODEL || process.env.BEEKNOEE_IMPORT_MODEL || 'google/gemini-3.1-flash-lite'),
    importFallbackModel: normalizeBeeknoeeModel(process.env.ADMIN_EXAM_AI_IMPORT_FALLBACK_MODEL || process.env.ADMIN_EXAM_AI_IMPORT_MODEL || process.env.ADMIN_EXAM_AI_MODEL || process.env.NINEROUTER_MODEL || process.env.BEEKNOEE_IMPORT_FALLBACK_MODEL || process.env.BEEKNOEE_IMPORT_MODEL || 'google/gemini-3.1-flash-lite'),
    reviewModel: normalizeBeeknoeeModel(process.env.ADMIN_EXAM_AI_REVIEW_MODEL || process.env.ADMIN_EXAM_AI_MODEL || process.env.NINEROUTER_MODEL || process.env.BEEKNOEE_REVIEW_MODEL || 'google/gemini-3.1-flash-lite'),
    fixModel: normalizeBeeknoeeModel(process.env.ADMIN_EXAM_AI_FIX_MODEL || process.env.ADMIN_EXAM_AI_REVIEW_MODEL || process.env.ADMIN_EXAM_AI_MODEL || process.env.NINEROUTER_MODEL || process.env.BEEKNOEE_REVIEW_MODEL || 'google/gemini-3.1-flash-lite'),
    ocrModels: normalizeModelEnvList(process.env.ADMIN_EXAM_AI_OCR_MODELS, process.env.ADMIN_EXAM_AI_OCR_MODEL, process.env.ADMIN_EXAM_AI_MODEL, process.env.NINEROUTER_MODEL, process.env.BEEKNOEE_OCR_MODEL, 'google/gemini-3.1-flash-lite'),
    importModels: normalizeModelEnvList(process.env.ADMIN_EXAM_AI_IMPORT_MODELS, process.env.ADMIN_EXAM_AI_IMPORT_MODEL, process.env.ADMIN_EXAM_AI_IMPORT_FALLBACK_MODEL, process.env.ADMIN_EXAM_AI_MODEL, process.env.NINEROUTER_MODEL, process.env.BEEKNOEE_IMPORT_MODEL, 'google/gemini-3.1-flash-lite'),
    reviewModels: normalizeModelEnvList(process.env.ADMIN_EXAM_AI_REVIEW_MODELS, process.env.ADMIN_EXAM_AI_REVIEW_MODEL, process.env.ADMIN_EXAM_AI_MODEL, process.env.NINEROUTER_MODEL, process.env.BEEKNOEE_REVIEW_MODEL, 'google/gemini-3.1-flash-lite'),
    fixModels: normalizeModelEnvList(process.env.ADMIN_EXAM_AI_FIX_MODELS, process.env.ADMIN_EXAM_AI_FIX_MODEL, process.env.ADMIN_EXAM_AI_REVIEW_MODEL, process.env.ADMIN_EXAM_AI_MODEL, process.env.NINEROUTER_MODEL, process.env.BEEKNOEE_REVIEW_MODEL, 'google/gemini-3.1-flash-lite'),
