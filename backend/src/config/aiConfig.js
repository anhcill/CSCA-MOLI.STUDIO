...
const config = {
  ...
  beeknoee: {
    ...
    importModel: process.env.BEEKNOEE_IMPORT_MODEL || 'gemini-3.1-flash-lite-preview',
    importFallbackModel: process.env.BEEKNOEE_IMPORT_FALLBACK_MODEL || process.env.BEEKNOEE_IMPORT_MODEL || 'gemini-3.1-flash-lite-preview',
