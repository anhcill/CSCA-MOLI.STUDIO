...
export default function HoaDeMoPhongPage() {
    ...
    const colorScheme = { from: 'from-emerald-500', via: 'via-teal-600', to: 'to-cyan-600' };
    ...
    return (
        <div className="min-h-screen bg-slate-50 relative overflow-hidden">
            ...
            <main className="container mx-auto px-4 md:px-6 py-6 md:py-8 max-w-[1400px] relative z-10">
                <div className={`w-full rounded-[2rem] bg-gradient-to-r ${colorScheme.from} ${colorScheme.via} ${colorScheme.to} p-8 lg:p-12 shadow-xl shadow-teal-900/10 relative overflow-hidden text-white flex flex-col md:flex-row items-center justify-between gap-8 mb-8`}>
