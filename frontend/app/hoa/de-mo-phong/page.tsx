...
export default function HoaDeMoPhongPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 relative overflow-hidden">
            <div className={`absolute top-0 left-1/4 w-full h-[500px] bg-gradient-to-br from-emerald-500 opacity-5 blur-[120px] pointer-events-none`} />
            
            <Header />

            <main className="container mx-auto px-4 md:px-6 py-6 md:py-8 max-w-[1400px] relative z-10">
                <div className={`w-full rounded-[2rem] bg-gradient-to-r ${colorScheme.from} ${colorScheme.to} p-8 lg:p-12 shadow-xl shadow-teal-900/10 relative overflow-hidden text-white flex flex-col md:flex-row items-center justify-between gap-8 mb-8`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-6">
                        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-gray-100 shadow-sm px-6 py-5 flex items-center justify-between">
                            ...
                            <AdminExamButton href="/admin/exams/create" gradientClass="from-emerald-500 to-cyan-600" shadowClass="shadow-emerald-500/20" hoverClass="hover:shadow-emerald-500/40 hover:-translate-y-0.5" />
                        </div>
