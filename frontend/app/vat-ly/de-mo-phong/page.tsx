    ...
    return (
        <div className="min-h-screen bg-slate-50 relative overflow-hidden">
            ...
            <main className="container mx-auto px-4 md:px-6 py-6 md:py-8 max-w-[1400px] relative z-10">
                <div className={`w-full rounded-[2rem] bg-gradient-to-r ${colorScheme.from} ${colorScheme.to} p-8 lg:p-12 shadow-xl shadow-orange-900/10 relative overflow-hidden text-white flex flex-col md:flex-row items-center justify-between gap-8 mb-8`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-6">
                        ...
                        {/* Exam List */}
                        <ExamList subjectCode={subjectCode} subjectSlug="vat-ly" />
                    </div>
