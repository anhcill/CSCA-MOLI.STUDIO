    ...
    return (
        <div className="min-h-screen bg-slate-50 relative overflow-hidden">
            ...
            <main className="container mx-auto px-4 md:px-6 py-4 md:py-6 max-w-[1400px] relative z-10">
                <div className={`w-full rounded-2xl bg-gradient-to-r ${colorScheme.from} ${colorScheme.to} p-5 lg:p-6 shadow-lg shadow-orange-900/10 relative overflow-hidden text-white flex items-center justify-between gap-4 mb-5`}>
