                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-6">
                        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-gray-100 shadow-sm px-6 py-5 flex items-center justify-between">
                            ...
                            <AdminExamButton href="/admin/exams/create" gradientClass="from-violet-600 to-fuchsia-600" shadowClass="shadow-violet-500/20" hoverClass="hover:shadow-violet-500/40 hover:-translate-y-0.5" />
                        </div>
