...
export default function TiengTrungXaHoiDeMoPhongPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 relative overflow-hidden">
            <div className={`absolute top-0 left-1/4 w-full h-[500px] bg-gradient-to-br from-rose-500 opacity-5 blur-[120px] pointer-events-none`} />
            
            <Header />

            <main className="w-full mx-auto px-4 md:px-6 xl:px-10 py-4 md:py-6 max-w-none relative z-10">
                <div className={`w-full rounded-2xl bg-gradient-to-r ${colorScheme.from} ${colorScheme.to} p-5 lg:p-6 shadow-lg shadow-rose-900/10 relative overflow-hidden text-white flex items-center justify-between gap-4 mb-5`}>
                    ...
                    <div className="relative z-10 w-full max-w-3xl">
                        <h1 className="text-xl lg:text-2xl font-black drop-shadow-md tracking-tight leading-tight">
                            Đề Mô Phỏng Tiếng Trung Xã Hội
                        </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-9 flex flex-col gap-6">
                        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-gray-100 shadow-sm px-6 py-5 flex items-center justify-between">
                            ...
                            <AdminExamButton href="/admin/exams/create" gradientClass="from-rose-500 to-purple-600" shadowClass="shadow-rose-500/20" hoverClass="hover:shadow-rose-500/40 hover:-translate-y-0.5" />
                        </div>

                        {/* Exam List */}
                        <ExamList subjectCode={subjectCode} subjectSlug="tiengtrung-xahoi" />
                    </div>

                    {/* Sidebar */}
                    <div className="lg:col-span-3">
                        <SubjectNavigation
                            subject="Tiếng Trung XH"
                            subjectCode="CHINESE_SOC"
