...
const COPY: CopyMap = {
  ...
  'nav.feedback': { vi: 'Góp ý', en: 'Feedback', zh: '反馈' },
  ...
  'auth.identifier': { vi: 'Email hoặc tên đăng nhập', en: 'Email or username', zh: '邮箱或用户名' },
  'auth.identifierPlaceholder': { vi: 'example@email.com hoặc username123', en: 'example@email.com or username123', zh: 'example@email.com 或 username123' },
  'auth.emailRegister': { vi: 'Hoặc đăng ký bằng email', en: 'Or sign up with email', zh: '或使用邮箱注册' },
  'auth.socialLogin': { vi: 'Hoặc đăng nhập với', en: 'Or log in with', zh: '或使用以下方式登录' },
  'auth.socialRegister': { vi: 'Hoặc đăng ký với', en: 'Or sign up with', zh: '或使用以下方式注册' },
  ...
  'auth.requiredIdentifier': { vi: 'Vui lòng nhập email hoặc tên đăng nhập', en: 'Please enter your email or username', zh: '请输入邮箱或用户名' },
  'auth.invalidIdentifier': { vi: 'Email hoặc tên đăng nhập không hợp lệ', en: 'Enter a valid email or username', zh: '邮箱或用户名格式不正确' },
  ...
  'auth.googleLoginNotConfigured': { vi: 'Đăng nhập Google chưa được cấu hình.', en: 'Google login is not configured.', zh: 'Google 登录尚未配置。' },
  ...
  'auth.googleRegisterNotConfigured': { vi: 'Đăng ký Google chưa được cấu hình.', en: 'Google sign up is not configured.', zh: 'Google 注册尚未配置。' },
  ...
  'auth.registerTermsRequired': { vi: 'Vui lòng tích chọn đồng ý Điều khoản sử dụng và Chính sách bảo mật trước khi đăng ký bằng Google hoặc Facebook.', en: 'Please accept the Terms of Use and Privacy Policy before signing up with Google or Facebook.', zh: '使用 Google 或 Facebook 注册前，请先勾选同意使用条款和隐私政策。' },
  ...
  'vocab.speaking': { vi: 'Đang phát âm', en: 'Speaking', zh: '正在朗读' },
  'vocab.speechUnsupported': { vi: 'Trình duyệt này không hỗ trợ phát âm. Hãy dùng Chrome/Edge hoặc bật giọng nói tiếng Trung trên máy.', en: 'This browser does not support speech. Use Chrome/Edge or enable a Chinese voice on your device.', zh: '此浏览器不支持朗读。请使用 Chrome/Edge，或在设备上启用中文语音。' },
  'vocab.speechFailed': { vi: 'Chưa phát được âm thanh. Bấm lại loa hoặc kiểm tra âm lượng/giọng nói tiếng Trung của máy.', en: 'Could not play audio. Press the speaker again or check volume/Chinese voice settings.', zh: '暂时无法播放声音。请再点一次喇叭，或检查音量/中文语音设置。' },
  ...
  'course.section.formulas': { vi: 'Công thức ôn thi', en: 'Exam formulas', zh: '考试公式' },
  ...
  'course.title.formulas': { vi: 'Công Thức Ôn Thi', en: 'Exam Formulas', zh: '考试公式' },
