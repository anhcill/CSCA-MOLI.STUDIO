...
export default function QuestionExplanationBlock({
  ...
  if (!question.explanation && !question.explanation_cn && !question.explanation_en && !question.explanation_image_url) return null;
  ...
  return (
    <div className={`rounded-xl border border-blue-200 bg-blue-50 p-4 shadow-sm dark:border-blue-900/60 dark:bg-blue-950/25 ${className}`}>
      ...
      {(question.explanation || question.explanation_cn || question.explanation_en) && (
        <BilingualMathText
