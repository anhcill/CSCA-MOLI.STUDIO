...
export default function RegisterForm() {
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="mb-6">
        <GoogleLogin onSuccess={handleGoogleSuccess} onError={handleGoogleError} useOneTap theme="outline" size="large" text="signup_with" width="100%" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input type="text" id="username" name="username" autoComplete="username" value={formData.username} onChange={handleChange}
        ...
        <div>
          ...
          <input type="text" id="full_name" name="full_name" autoComplete="name" value={formData.full_name} onChange={handleChange}
        ...
        <div>
          ...
          <input type="password" id="confirmPassword" name="confirmPassword" autoComplete="new-password" value={formData.confirmPassword} onChange={handleChange}
        ...
        <div className="flex items-start">
          ...
          <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
            Khi đăng ký, bạn đồng ý với <a href="/dieu-khoan-su-dung" className="text-indigo-600 hover:underline">Điều khoản sử dụng</a> và <a href="/chinh-sach-bao-mat" className="text-indigo-600 hover:underline">Chính sách bảo mật</a>
          </label>
        </div>
